...
| [`humanizer`](skills/humanizer/SKILL.md) | Rewrites or drafts text (German or English) to remove telltale signs of AI-generated writing — buzzword vocabulary, filler transitions, vague attributions, and a hard ban on em dashes — while keeping the intended register (business vs. casual). Includes a script that mechanically scans a draft for em dashes and flagged phrases before it's returned. |
